...
namespace ArenaShooter.Infrastructure.DI
{
    public class GameSceneInstaller : MonoInstaller
    {
        ...
        private void InstallPools()
        {
            ...
            Container.BindFactory<EnemyView, EnemyConfig, EnemyEntity, EnemyEntity.Factory>();
